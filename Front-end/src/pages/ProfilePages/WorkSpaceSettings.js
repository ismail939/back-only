                    ...
                    <div className="w-full">
                        ...
                        <div>
                            ...
                            <div className="flex flex-row-reverse w-full items-center gap-5">
                                ...
                                <label htmlFor="uploadSecImg" className="py-2 px-4 font-medium rounded-lg text-white bg-[#3282B8] hover:bg-[#4292C8] duration-200 cursor-pointer">ADD NEW PHOTO</label>
                            </div>
                        </div>
                    </div>
                </div>
